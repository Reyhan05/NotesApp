package com.reyhan.presentation.add
...
import com.reyhan.noteapp.databinding.FragmentAddBinding
import com.reyhan.presentation.update.NotesViewModel
import com.reyhan.utils.ExtensionFunction.setActionBar
import com.reyhan.utils.HelperFunction.parseToPriority
import com.reyhan.utils.HelperFunction.setPriorityColor
    ...
    private fun insertNotes() {
        binding.apply {
            ...
            if (edtTitle.text.isEmpty() || edtDescription.text.isEmpty()) {
                ...
                Toast.makeText(context, "Sukses menambah Note", Toast.LENGTH_SHORT).show()
